...
final class CustomAsyncHelper {
   ...
   private static final int SOURCEID_FACILITY_COL_NUM = 7;
   private static final int SOURCEID_PATIENT_COL_NUM = 8;
   private static final int PHONETIC_GIVEN_NAME_COL_NUM = 1;
   private static final int PHONETIC_FAMILY_NAME_COL_NUM = 2;
   ...
   static CustomDemographicData customDemographicData(final CSVRecord csvRecord) {
      return new CustomDemographicData(
         csvRecord.get(PHONETIC_GIVEN_NAME_COL_NUM),
         csvRecord.get(PHONETIC_FAMILY_NAME_COL_NUM),
