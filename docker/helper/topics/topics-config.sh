...
REPLICATION[$TOPIC_PATIENT_ASYNC_ETL]=1
REPLICATION[$TOPIC_PATIENT_CONTROLLER]=1
REPLICATION[$TOPIC_PATIENT_EM]=1
REPLICATION[$TOPIC_PATIENT_LINKER]=1
...
RETENTION_MS[$TOPIC_BACK_PATCH_DWH]=`echo "1*24*60*60*1000" | bc`
